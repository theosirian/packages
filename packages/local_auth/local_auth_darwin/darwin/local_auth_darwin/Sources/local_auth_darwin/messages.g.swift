...
enum AuthResult: Int {
  ...
  case successValidated = 1
  /// The user authenticated successfully, and biometric checking was false.
  case successInvalidated = 2
  /// The user failed to successfully authenticate.
  case failure = 3
  /// Native UI needed to be displayed, but couldn't be.
  case uiUnavailable = 4
  case appCancel = 5
  case systemCancel = 6
  case userCancel = 7
  case biometryDisconnected = 8
  case biometryLockout = 9
  case biometryNotAvailable = 10
  case biometryNotEnrolled = 11
  case biometryNotPaired = 12
  case authenticationFailed = 13
  case invalidContext = 14
  case invalidDimensions = 15
  case notInteractive = 16
  case passcodeNotSet = 17
  case userFallback = 18
  /// An error other than the expected types occurred.
  case unknownError = 19
  /// No biometrics are enrolled.
  case errorNotEnrolled = 20
  /// No passcode is set.
  case errorPasscodeNotSet = 21
  /// Biometric checking failed.
  case errorBiometricChecking = 22
}
...
struct AuthOptions: Hashable {
  ...
  var sticky: Bool
  var checkBiometricInvalidationForKey: Bool
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> AuthOptions? {
    ...
    let checkBiometricInvalidationForKey = pigeonVar_list[2] as! Bool
...
class LocalAuthApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: LocalAuthApi?, messageChannelSuffix: String = "") {
    ...
    /// Clear biometric checking variables
    let clearBiometricCheckingChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.clearBiometricChecking\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      clearBiometricCheckingChannel.setMessageHandler { _, reply in
        do {
          try api.clearBiometricChecking()
      ...
      clearBiometricCheckingChannel.setMessageHandler(nil)
    }
  }
}
