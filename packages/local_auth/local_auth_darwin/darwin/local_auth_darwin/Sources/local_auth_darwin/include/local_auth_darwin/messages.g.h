...
typedef NS_ENUM(NSUInteger, FLADAuthResult) {
  ...
  FLADAuthResultSuccessValidated = 1,
  /// The user authenticated successfully, and biometric checking was false.
  FLADAuthResultSuccessInvalidated = 2,
  /// The user failed to successfully authenticate.
  FLADAuthResultFailure = 3,
  /// The authentication system was not available.
  FLADAuthResultErrorNotAvailable = 4,
  /// No biometrics are enrolled.
  FLADAuthResultErrorNotEnrolled = 5,
  /// No passcode is set.
  FLADAuthResultErrorPasscodeNotSet = 6,
  /// Biometric checking failed.
  FLADAuthResultErrorBiometricChecking = 7,
};
...
@property(nonatomic, assign) BOOL  checkBiometricInvalidationForKey;
@end
...
///
/// @return `nil` only when `error != nil`.
- (nullable NSArray<FLADAuthBiometricBox *> *)getEnrolledBiometricsWithError:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)clearBiometricCheckingWithError:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpFLADLocalAuthApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLADLocalAuthApi> *_Nullable api);

extern void SetUpFLADLocalAuthApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLADLocalAuthApi> *_Nullable api, NSString *messageChannelSuffix);
