...
+ (instancetype)makeWithBiometricOnly:(BOOL )biometricOnly
    ...
    checkBiometricInvalidationForKey:(BOOL )checkBiometricInvalidationForKey {
  ...
  pigeonResult.checkBiometricInvalidationForKey = checkBiometricInvalidationForKey;
  return pigeonResult;
}
+ (FLADAuthOptions *)fromList:(NSArray<id> *)list {
  FLADAuthOptions *pigeonResult = [[FLADAuthOptions alloc] init];
  ...
  pigeonResult.checkBiometricInvalidationForKey = [GetNullableObjectAtIndex(list, 3) boolValue];
  return pigeonResult;
}
+ (nullable FLADAuthOptions *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    @(self.checkBiometricInvalidationForKey),
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    case 129: {
      ...
      return enumAsNumber == nil ? nil : [[FLADAuthResultBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 130: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FLADAuthBiometricBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 131: 
...
NSObject<FlutterMessageCodec> *FLADGetMessagesCodec(void) {
  ...
  dispatch_once(&sPred, ^{
    FLADMessagesPigeonCodecReaderWriter *readerWriter = [[FLADMessagesPigeonCodecReaderWriter alloc] init];
...
void SetUpFLADLocalAuthApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLADLocalAuthApi> *api, NSString *messageChannelSuffix) {
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  /// Returns true if this device supports authentication.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.isDeviceSupported", messageChannelSuffix]
  ...
  /// any biometrics are enrolled or not.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.deviceCanSupportBiometrics", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FLADGetMessagesCodec()];
    if (api) {
  ...
  /// without additional setup.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.getEnrolledBiometrics", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FLADGetMessagesCodec()];
    if (api) {
  ...
  /// [strings] for any UI.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.authenticate", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FLADGetMessagesCodec()];
    if (api) {
  ...
  /// Clear biometric checking variables
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.clearBiometricChecking", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FLADGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(clearBiometricCheckingWithError:)], @"FLADLocalAuthApi api (%@) doesn't respond to @selector(clearBiometricCheckingWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        [api clearBiometricCheckingWithError:&error];
