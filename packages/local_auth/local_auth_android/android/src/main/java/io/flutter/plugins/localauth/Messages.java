...
public class Messages {
  ...
  public static final class AuthOptions {
    ...
    public boolean equals(Object o) {
      ...
      return biometricOnly.equals(that.biometricOnly) && sensitiveTransaction.equals(that.sensitiveTransaction) && sticky.equals(that.sticky) && checkBiometricInvalidationForKey.equals(that.checkBiometricInvalidationForKey);
    }

    @Override
    public int hashCode() {
      return Objects.hash(biometricOnly, sensitiveTransaction, sticky, checkBiometricInvalidationForKey);
    }
