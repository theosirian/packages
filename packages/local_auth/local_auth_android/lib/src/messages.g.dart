...
class AuthOptions {
  ...
  static AuthOptions decode(Object result) {
    ...
    return AuthOptions(
      ...
      checkBiometricInvalidationForKey: result[3]! as bool,
    );
  }
...
class LocalAuthApi {
  ...
  Future<void> clearBiometricChecking() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.local_auth_android.LocalAuthApi.clearBiometricChecking$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
